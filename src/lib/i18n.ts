...
const messages = {
  en: {
    ...
    discover: {
      ...
      switchToTwoColumns: "Switch to two columns",
      switchToSingleColumn: "Switch to single column",
  ...
  zh: {
    ...
    discover: {
      ...
      showFilters: "展开筛选",
      hideFilters: "收起筛选",
      switchToTwoColumns: "切换为双排",
      switchToSingleColumn: "切换为单排",
      categoryLabel: "分类",
      sortLabel: "排序",
      latest: "最新",
      popular: "热门",
  ...
  it: {
    ...
    discover: {
      ...
      switchToTwoColumns: "Passa a due colonne",
      switchToSingleColumn: "Passa a una colonna",
  ...
  es: {
    ...
    discover: {
      ...
      switchToTwoColumns: "Cambiar a dos columnas",
      switchToSingleColumn: "Cambiar a una columna",
