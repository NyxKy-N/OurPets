      ...
      <body className="flex min-h-full flex-col overflow-x-hidden">
        <Providers session={session} initialLocale={locale} initialMessages={messages}>
          ...
          <footer className="px-4 pb-10 pt-6">
            <div className="glass-panel mx-auto max-w-6xl rounded-[30px] px-5 py-5 sm:px-7 sm:py-6">
              ...
              <div className="mt-5 h-px w-full bg-gradient-to-r from-transparent via-foreground/12 to-transparent" />
              <div className="mt-4 text-xs font-medium tracking-[0.18em] text-muted-foreground/90">
